export const servicesData = {
  "voo-atrasado": {
    ...
    seo: {
      ...
      keywords: ["voo atrasado indenização", "advogado voo atrasado", "direitos voo atrasado", "ANAC voo atrasado", "passageiro aéreo Brasil"],
      canonical: "https://www.lexaero.com.br/voo-atrasado",
      openGraph: {
        title: "Voo Atrasado: Você Pode Ter Direito a Indenização | LexAero",
        description: "Atraso superior a 4 horas pode gerar indenização. Análise gratuita online em 2 minutos.",
        url: "https://www.lexaero.com.br/voo-atrasado",
      },
    },
    hero: {
  ...
  "voo-cancelado": {
    ...
    seo: {
      ...
      keywords: ["voo cancelado indenização", "advogado voo cancelado", "direitos voo cancelado", "cancelamento voo ANAC"],
      canonical: "https://www.lexaero.com.br/voo-cancelado",
      openGraph: {
        title: "Voo Cancelado: Exija Seus Direitos | LexAero",
        description: "Voo cancelado sem aviso ou assistência? Avalie gratuitamente seu caso de indenização.",
        url: "https://www.lexaero.com.br/voo-cancelado",
      },
    },
    hero: {
  ...
  "overbooking": {
    ...
    seo: {
      ...
      keywords: ["overbooking indenização", "embarque negado direitos", "preterição passageiro", "ANAC overbooking"],
      canonical: "https://www.lexaero.com.br/overbooking",
      openGraph: {
        title: "Overbooking: Seus Direitos como Passageiro | LexAero",
        description: "Impedido de embarcar? A companhia deve compensação imediata. Avalie seu caso gratuitamente.",
        url: "https://www.lexaero.com.br/overbooking",
      },
    },
    hero: {
  ...
  "bagagem": {
    ...
    seo: {
      ...
      keywords: ["bagagem extraviada indenização", "mala perdida direitos", "RIB bagagem", "extravio bagagem ANAC", "dano bagagem passageiro"],
      canonical: "https://www.lexaero.com.br/bagagem",
      openGraph: {
        title: "Bagagem Extraviada ou Danificada: Seus Direitos | LexAero",
        description: "Mala perdida, danificada ou violada? Conheça seus direitos e verifique indenização.",
        url: "https://www.lexaero.com.br/bagagem",
      },
    },
    hero: {
  ...
  "conexao-perdida": {
    ...
    seo: {
      ...
      keywords: ["perda de conexão indenização", "conexão perdida voo", "reacomodação voo Brasil", "atraso conexão direitos"],
      canonical: "https://www.lexaero.com.br/conexao-perdida",
      openGraph: {
        title: "Perdeu a Conexão por Culpa da Companhia? | LexAero",
        description: "Perda de conexão por atraso gera direito a reacomodação e indenização. Avalie gratuitamente.",
        url: "https://www.lexaero.com.br/conexao-perdida",
      },
    },
    hero: {
