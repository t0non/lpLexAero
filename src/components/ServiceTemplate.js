            ...
            <div className="kareline__content" style={{ position: "relative" }}>
              ...
              <div className="kareline-btn-wrap">
                <Link href="/diagnostico" className="btn btn--primary btn--lg" style={{ color: "var(--lex-black)", display: "inline-flex" }}>
                  ...
                  <span className="btn__icon-circle" aria-hidden="true" style={{ background: "#ffffff", color: "var(--lex-gold)" }}><img src="/aviao.svg" width="20" height="20" alt="" aria-hidden="true" style={{filter:"brightness(0) invert(1)"}}/></span>
                </Link>
              </div>
            </div>
          </div>
