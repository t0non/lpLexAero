      ...
      <section className="section bg-graphite" aria-labelledby="numbers-heading">
        <div className="container">
          ...
          <div style={{ marginTop: "3rem", textAlign: "center" }}>
            <Link href={diagUrl} className="btn btn--primary btn--lg" style={{ display: "inline-flex", padding: "1rem 3rem", fontSize: "1.05rem", fontWeight: "bold", borderRadius: "9999px", alignItems: "center", gap: "0.5rem" }}>
