...
export default function DiagnosticForm({ initialProblem = null, isEmbedded = false }) {
        ...
        <div className="r-card" style={{
          ...
          <div style={{ padding: "0.5rem 0" }}>
            ...
            <p style={{ fontSize: "0.9rem", color: "#374151", lineHeight: 1.65, margin: "0 0 1.5rem" }}>
              {leadData.nome.split(" ")[0]}, seu caso tem <strong style={{ color: "#111827" }}>boas chances de indenização</strong>. Casos com perfil similar ao seu costumam resultar em valores entre <strong style={{ color: "var(--lex-gold)" }}>R$ 3.000 e R$ 15.000</strong>. Posso analisar melhor os detalhes com você.
            </p>
  ...
  return (
    <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      {!isEmbedded && (
        <div style={{ marginTop: "1.5rem", fontSize: "0.78rem", color: C.textMuted, maxWidth: 520, display: "flex", alignItems: "flex-start", justifyContent: "center", gap: "0.4rem", textAlign: "left" }}>
          <svg width={14} height={14} viewBox="0 0 24 24" fill="none" stroke={C.gold} strokeWidth="2" style={{ flexShrink: 0, marginTop: "2px" }}>
