...
export const metadata = {
  title: "LexAero | Voo Atrasado ou Cancelado? ConheÃ§a Seus Direitos",
  description: "Boutique jurÃ­dica especializada em Direito do Passageiro AÃ©reo. AnÃ¡lise individualizada para problemas com voos e bagagem.",
};

const PROBLEMS = [
  {
    title: "Voo atrasado",
    desc: "Atrasos superiores a 4 horas podem gerar direitos ao passageiro. Avaliamos a documentaÃ§Ã£o do seu voo e orientamos os prÃ³ximos passos.",
    href: "/voo-atrasado",
  ...
  {
    title: "Voo cancelado",
    desc: "Cancelamentos sem assistÃªncia adequada podem ensejar medidas. Entenda o que a companhia deveria ter feito e como proceder.",
    href: "/voo-cancelado",
  ...
  {
    title: "Overbooking",
    desc: "Embarque negado por excesso de passageiros? Verificamos sua elegibilidade a reparaÃ§Ã£o e medidas cabÃ­veis.",
    href: "/overbooking",
  ...
  {
    title: "ConexÃ£o perdida / ReacomodaÃ§Ã£o",
    desc: "Acompanhe seus direitos a assistÃªncia material e opÃ§Ãµes oferecidas pela companhia ao perder uma conexÃ£o.",
    href: "/conexao-perdida",
    icon: (<img src="/icone-perda-conexao.png" alt="ConexÃ£o perdida" style={{ width: '64px', height: '64px', objectFit: 'contain', marginLeft: '-6px', marginTop: '-6px' }} />),
  },
];
...
const FAQS = [
  {
    ...
    a: "Atrasos superiores a certas horas, cancelamentos, overbooking (preteriÃ§Ã£o de embarque), extravio ou dano de bagagem e ausÃªncia de assistÃªncia material sÃ£o as situaÃ§Ãµes mais comuns. A anÃ¡lise de cada caso considera as circunstÃ¢ncias especÃ­ficas, os documentos disponÃ­veis e a legislaÃ§Ã£o aplicÃ¡vel.",
  },
  {
    q: "O que devo guardar apÃ³s um problema com voo?",
    a: "Guarde o cartÃ£o de embarque, o comprovante de reserva, e-mails e mensagens da companhia, protocolos de atendimento, declaraÃ§Ã£o de atraso ou cancelamento, comprovantes de gastos extras e fotografias do painel de chegadas e partidas.",
  },
  {
    q: "O que acontece quando perco uma conexÃ£o por atraso?",
    a: 'Quando os trechos fazem parte do mesmo bilhete (localizador Ãºnico), a companhia responsÃ¡vel pelo voo que atrasou deve garantir a chegada ao destino final e fornecer assistÃªncia material. A situaÃ§Ã£o pode ser diferente quando os bilhetes foram adquiridos separadamente.',
  },
  {
    q: "Como funciona a assistÃªncia material?",
    a: "A ResoluÃ§Ã£o nÂº 400 da ANAC determina que a companhia deve oferecer, progressivamente: comunicaÃ§Ã£o a partir de 1 hora de atraso, alimentaÃ§Ã£o a partir de 2 horas, e acomodaÃ§Ã£o e transporte a partir de 4 horas â€” ou na interrupÃ§Ã£o da viagem com pernoite.",
  },
  {
    q: "O atendimento da LexAero Ã© realizado online?",
    a: "Sim. A LexAero possui estrutura para atendimento digital e anÃ¡lise de situaÃ§Ãµes envolvendo passageiros de qualquer parte do Brasil.",
  },
  {
    q: "Como funciona o diagnÃ³stico preliminar?",
    a: "O diagnÃ³stico Ã© uma ferramenta informativa. VocÃª responde perguntas sobre sua situaÃ§Ã£o e, ao final, pode solicitar uma anÃ¡lise jurÃ­dica individualizada. NÃ£o constitui parecer jurÃ­dico.",
  },
];
...
const CONTENT_CARDS = [
  ...
  { tag: "Cancelamento", title: "Voo cancelado", desc: "Entenda quando cabe indenizaÃ§Ã£o.", href: "/voo-cancelado", icon: <img src="/icone-voo-cancelado.png" alt="" style={{ width: '36px', height: '36px', objectFit: 'contain' }} /> },
  ...
  { tag: "Bagagem", title: "Extravio de bagagem", desc: "ConheÃ§a seus direitos sobre bagagem.", href: "/bagagem", icon: <img src="/icone-bagagem.png" alt="" style={{ width: '36px', height: '36px', objectFit: 'contain' }} /> },
  { tag: "ConexÃ£o", title: "ConexÃ£o perdida", desc: "Veja o que fazer em voos com conexÃ£o.", href: "/conexao-perdida", icon: <img src="/icone-perda-conexao.png" alt="" style={{ width: '36px', height: '36px', objectFit: 'contain' }} /> },
];

export default function Home() {
  return (
    <>
      {/* â”€â”€ HERO: Founder-Led â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="hero__inner">
            ...
            <div className="hero__left">
              ...
              <h1 className="hero__headline">
                VocÃª pode ter direito a <span className="hero-mobile-nowrap"><span style={{ color: 'var(--lex-gold)' }}>atÃ© R$ 10 mil</span> em indenizaÃ§Ã£o.</span>
              </h1>
              <p className="hero__sub">
                Atraso, cancelamento, conexÃ£o perdida, overbooking ou problema com bagagem?
              </p>
      ...
      {/* â”€â”€ DEPOIMENTOS (SOCIAL PROOF RÃPIDO) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <Testimonials />



      {/* â”€â”€ O QUE ACONTECEU â€” FUNDO BRANCO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        <div className="container">
          <div className="text-center" style={{ maxWidth: 600, margin: "0 auto 3rem" }}>
            ...
            <p style={{ marginTop: "0.75rem" }}>
              ConheÃ§a informaÃ§Ãµes relacionadas Ã  situaÃ§Ã£o enfrentada no seu voo.
            </p>
          </div>
          <div className="problems-grid">
            ...
            <div className="card" style={{ background: 'var(--lex-gold-bg)', borderColor: 'var(--lex-gold)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: 'var(--space-6) var(--space-4)' }}>
              ...
              <h3 className="card__title" style={{ fontSize: '1.25rem', color: 'var(--lex-gold-dark)', marginBottom: '0.5rem', fontWeight: 600 }}>O direito Ã© seu!</h3>
              <p className="card__desc" style={{ fontSize: '15px', color: 'var(--lex-text)', marginBottom: '1.5rem', fontWeight: 500, lineHeight: 1.4 }}>
                NÃ£o deixe para depois. Reivindique o que Ã© seu por direito e resolva seu problema com a companhia aÃ©rea hoje mesmo.
              </p>
      ...
      {/* â”€â”€ DIAGNÃ“STICO CTA â€” VIDEO BACKGROUND PREMIUM â”€â”€â”€â”€â”€ */}
      <section className="section video-cta-section" aria-labelledby="diag-heading" style={{ position: "relative", overflow: "hidden", minHeight: "700px", display: "flex", alignItems: "center", padding: "var(--space-12) 0" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "3rem", justifyContent: "space-between" }}>
            ...
            {/* Coluna Direita: DiagnÃ³stico Embutido */}
      ...
      {/* â”€â”€ COMO FUNCIONA â€” FUNDO IVORY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ QUANTO VOU PAGAR (Pricing) â€” FUNDO BRANCO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        <div className="container">
          <div className="pricing-grid">
            <div className="pricing__content" style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
              ...
              <p>Trabalhamos para o seu sucesso! Se nÃ£o conseguirmos que sua <strong style={{color: "var(--lex-gold-dark)"}}>indenizaÃ§Ã£o por danos morais</strong> por problema com voo seja paga, nÃ£o cobramos nada pelo nosso serviÃ§o.</p>
              <p>Sem pegadinhas! Se a indenizaÃ§Ã£o entrar na sua conta, vocÃª paga 35% do valor recebido para a LexAero e fica com 65%.</p>
            ...
            <div className="pricing__visual">
              <div className="pricing__chart-wrapper">
                <img 
                  src="/grafico.png" 
                  alt="GrÃ¡fico de honorÃ¡rios: 65% para vocÃª, 35% para a LexAero"
              ...
              <div className="pricing__legend">
                <div className="legend-item">
                  ...
                  <p>VocÃª recebe sua indenizaÃ§Ã£o, <strong>sem burocracia</strong></p>
                </div>
                <div className="legend-item">
                  <span className="legend-dot dot-graphite"></span>
                  <p>A LexAero fica com 35% apÃ³s a resoluÃ§Ã£o do caso</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* â”€â”€ NÃšMEROS (SOCIAL PROOF) â€” FUNDO ESCURO â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ KARELINE â€” FUNDO ESCURO CINEMATOGRÃFICO â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="kareline-section">
            ...
            <div className="kareline__content" style={{ position: "relative" }}>
              ...
              <div style={{ textAlign: "left", position: "relative", zIndex: 2, display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <p style={{ lineHeight: 1.7, color: "var(--lex-text-dark-muted)", fontSize: "1.05rem", margin: 0 }}>
                  Nosso escritÃ³rio possui uma <strong style={{ color: "var(--lex-white)", fontWeight: 600 }}>taxa de sucesso superior a 90%</strong>, garantindo que o seu direito seja tratado com a mÃ¡xima seriedade, agilidade e eficiÃªncia.
                </p>
              </div>
      ...
      {/* â”€â”€ CAPTURA DE LEADS (Substitui Metodologia) â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="metodologia-section">
            ...
            <div className="metodologia__text" style={{ textAlign: "center" }}>
              ...
              <h2 id="diff-heading" className="nowrap-desktop" style={{ marginTop: "0.5rem", marginBottom: "1.25rem", fontWeight: 600 }}>
                NÃ£o deixe seus direitos para depois.{" "}
                <span style={{ color: "var(--lex-gold)" }}>Resolva em 2 minutos.</span>
              </h2>
              <p style={{ marginBottom: 0, fontSize: "0.875rem", lineHeight: "1.5" }}>
                Preencha o formulÃ¡rio abaixo para que nossa equipe avalie as circunstÃ¢ncias do seu caso e entre em contato rapidamente.
              </p>
            </div>
      ...
      <section className="section bg-dark">
          ...
          <div className="benefits-card" style={{ marginTop: "3rem" }}>
            <div className="benefits-card__content">
              <h2 style={{ color: "var(--lex-white)", marginBottom: "1.5rem", fontSize: "3rem", fontWeight: 600, lineHeight: 1.1 }}>NÃ³s cuidamos de tudo para vocÃª!</h2>
              <p style={{ color: "var(--lex-text-dark-muted)", marginBottom: "2rem", lineHeight: 1.7, fontSize: "1.05rem" }}>
                Escolher a LexAero Ã© garantir que seus direitos por problemas com voo sejam respeitados sem estresse e sem burocracia.
              </p>
              ...
              <ul className="benefits-list">
                {[
                  "AvaliaÃ§Ã£o grÃ¡tis em atÃ© 2 minutos;",
                  "Sem custo inicial e sÃ³ paga se ganhar;",
                  "Somos transparentes. VocÃª acompanha tudo em tempo real;",
                  "Especialistas em cancelamento, atraso, overbooking e bagagem;",
                  "ConfianÃ§a comprovada: dezenas de clientes satisfeitos em todo Brasil."
                ].map((motivo, i) => (
            ...
            <div className="benefits-card__image-wrap">
              ...
              <div className="benefits-card__caption">
                <p>
                  <strong>Avalie seu caso grÃ¡tis</strong> agora mesmo e descubra se vocÃª tem direito a uma <strong>indenizaÃ§Ã£o por problema com voo</strong>.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* â”€â”€ CENTRAL DE DIREITOS â€” PREMIUM REDESIGN â”€â”€ */}
      <section className="section bg-dark central-direitos-section-premium" aria-labelledby="content-heading">
        <div className="container central-direitos-container">
          ...
          {/* Esquerda: ConteÃºdo Header e Imagem */}
      ...
      {/* â”€â”€ FAQ â€” FUNDO IVORY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      <section className="section bg-ivory" aria-labelledby="blog-heading">
        <div className="container">
          <div className="text-center" style={{ maxWidth: 600, margin: "0 auto 0" }}>
            <span className="eyebrow">CONTEÃšDO GRATUITO</span>
            <h2 id="blog-heading" style={{ marginTop: "0.5rem" }}>Conhecimento que protege vocÃª</h2>
            <p style={{ color: "var(--lex-text-muted)", marginTop: "0.5rem" }}>Artigos escritos por especialistas para vocÃª entender seus direitos antes, durante e depois de qualquer problema com voo.</p>
          </div>
      ...
      {/* â”€â”€ CTA FINAL â€” FUNDO DOURADO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        <div className="container">
          <div className="cta-banner" style={{ background: "transparent", border: "none", padding: 0 }}>
            <h2 id="cta-heading" className="cta-banner__title" style={{ color: "var(--lex-black)", maxWidth: 800, margin: "0 auto var(--space-8)", fontWeight: 300 }}>
              Quer buscar seus direitos por problema com voo sem sair de casa? Ã‰ sÃ³ verificar grÃ¡tis!
            </h2>
